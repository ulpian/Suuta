...
// in simulator we redefine to format for testio Developer console
...
{\
	NSString * exceptionName = [@"org.testio." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.testio";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UItestioNativeItemNone = -1, 
	UItestioNativeItemSpinner = -2,
	UItestioNativeItemProgressBar = -3,
	
	UItestioNativeItemSlider = -4,
	UItestioNativeItemSwitch = -5,
	UItestioNativeItemMultiButton = -6,
	UItestioNativeItemSegmented = -7,
	
	UItestioNativeItemTextView = -8,
	UItestioNativeItemTextField = -9,
	UItestioNativeItemSearchBar = -10,
	
	UItestioNativeItemPicker = -11,
	UItestioNativeItemDatePicker = -12,
	
	UItestioNativeItemInfoLight = -13,
	UItestioNativeItemInfoDark = -14,
	
	UItestioNativeItemDisclosure = -15,
	
	UItestioNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all testio instances of
